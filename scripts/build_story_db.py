...
TOPIC_KEYWORDS: Dict[str, Sequence[str]] = {
    "character": ("人物", "来歴", "関係", "心理", "隊員", "聖女"),
    "operation": ("小隊", "班", "司令部", "任務", "作戦", "突入", "強制介入"),
    "law": ("法律", "法令", "労働局設置法", "監督", "臨検", "令状", "証拠保全"),
    "crime": ("人身売買", "違法移送", "強制労働", "組織犯罪", "収賄", "証拠隠滅"),
    "world": ("世界観", "オルセア", "企業群", "港湾", "福祉", "義体", "親和鉱石"),
    "equipment": ("武装", "車両", "装備", "輸送機", "警備ロボ", "ドアノッカー", "フォーアイズ"),
}
GENERIC_TITLES = {
    "概要",
    "要点",
